  ...
  <div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center">
      ...
      <nav class="hidden md:flex space-x-6">
        ...
        <a href="#" class="hover:text-blue-200 transition">Báo cáo</a>
      </nav>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div class="relative">
                    ...
                    <button type="button" class="absolute right-2 top-2 text-blue-600 hover:text-blue-800">
            ...
            <div class="fade-in">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="number" id="duration" name="duration" min="30" max="240" value="90"
                         class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition" required>
                </div>
              </div>
            </div>
